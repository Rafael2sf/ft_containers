...
int	main( void )
{
	...
	}
	{
		...
		for (int i = 0; i < 26; i++)
			v0.push_back('a' + i);
		for (Local::iterator iter = v0.begin(); iter != v0.end(); iter++)
			PRINT(*iter);
		for (Local::const_iterator iter = v0.begin(); iter != v0.end(); iter++)
			PRINT(*iter);
		for (Local::reverse_iterator iter = v0.rbegin(); iter != v0.rend(); iter++)
			PRINT(*iter);
		for (Local::const_reverse_iterator iter = v0.rbegin(); iter != v0.rend(); iter++)
			PRINT(*iter);
		...
		for (Local::iterator iter = --v0.end(); iter != v0.begin(); iter--)
			PRINT(*iter);
		for (Local::const_iterator iter = --v0.end(); iter != v0.begin(); iter--)
			PRINT(*iter);
		for (Local::reverse_iterator iter = --v0.rend(); iter != v0.rbegin(); iter--)
			PRINT(*iter);
		for (Local::const_reverse_iterator iter = --v0.rend(); iter != v0.rbegin(); iter--)
			PRINT(*iter);
	}
	{
