...
namespace ft
{
	...
	class vector
	{
		...
		typedef ptrdiff_t
			difference_type;
		typedef vector_iterator<value_type>
			iterator;
		typedef vector_iterator<const value_type>
			const_iterator;
		...
		{
			this->vFill(static_cast<size_type>(__n),
